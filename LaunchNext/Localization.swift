...
final class LocalizationManager {
    ...
    private init() {
        ...
        builder[.korean]?.merge([
            ...
            .backupCleanupIntroPrimary: "LaunchNext는 데이터베이스에 로컬 변경 기록을 저장합니다. 앱은 사용하지 않지만 시간이 지나면 커질 수 있습니다.",
            .backupCleanupIntroSecondary: "이 작업은 파괴적이고 데이터베이스를 닫아야 하므로 앱 내부에서 실행하지 않습니다. 터미널에서 수동으로 실행하면 데이터 손실을 방지할 수 있습니다.",
            .backupCleanupWarning: "중요: 이 명령을 실행하기 전에 LaunchNext를 종료하세요. 데이터베이스가 잠길 수 있습니다.",
        ...
        builder[.korean]?.merge([
            ...
            .performanceModeRestartMessage: "새 성능 모드를 적용하려면 LaunchNext를 재시작하세요.",
